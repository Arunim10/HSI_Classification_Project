...
def main():
    ...
    # masked_hdr_files = list(glob("D:\\Machine Learning\\Texmin_HSI\\HSI_Classification_Updated\\Minerals_Dataset\\Masked_HDR_Data\\Extracted_Folder\\*\\*.mhdr.h5"))
    ...
    #         hsi_mat_path = f'D:\\Machine Learning\\Texmin_HSI\\HSI_Classification_Updated\\Minerals_Dataset\\Minerals_mat_files\\{hsi_name}'
    #         mask_mat_path = f'D:\\Machine Learning\\Texmin_HSI\\HSI_Classification_Updated\\Minerals_Dataset\\Minerals_mat_files\\{mask_name}'
    ...
    #         continue
        ...
        for name,indices in tqdm(nan_img_even_after_fill_nan_function.items(),total=len(nan_img_even_after_fill_nan_function)):
            path = f"D:\\Machine Learning\\Texmin_HSI\\HSI_Classification_Updated\\Minerals_Dataset\\Minerals_mat_files\\00{name}.mat"
