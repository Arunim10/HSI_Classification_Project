...
def save_patches():
    ...
    # patch_df.to_csv("D:\\Machine Learning\\Texmin_HSI\\HSI_Classification_Updated\\Minerals_Dataset\\Codes_for_dataset\\Patch_df_for_any_window_size.csv",index=False)
    
    patch_df = pd.read_csv("D:\\Machine Learning\\Texmin_HSI\\HSI_Classification_Updated\\Minerals_Dataset\\Codes_for_dataset\\Patch_df_for_any_window_size.csv")
    # print(len(sorted(patch_df['ID'].unique())))
    patch_df.to_parquet('D:\\Machine Learning\\Texmin_HSI\\HSI_Classification_Updated\\Minerals_Dataset\\Codes_for_dataset\\Patch_df_for_any_window_size.parquet', index=False)
